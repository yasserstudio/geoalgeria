...
fitness for a particular purpose. The data **may be incomplete, outdated, or contain
errors**.

**Do not rely on this data for financial, payment, banking, KYC/AML, legal,
compliance, routing, or safety-critical purposes without independently verifying it
against the official, authoritative source.** RIB / `bank_code` and SWIFT/BIC values
in particular **must be verified** with the relevant institution before being used in
any transaction. Nothing in this project constitutes financial, legal, or professional
advice.

## Limitation of liability

To the maximum extent permitted by applicable law, the authors and contributors accept
**no liability** for any loss, damage, or claim arising from the use of, or reliance
on, this data or software. Use is entirely at your own risk. This is in addition to
the warranty and liability terms of the [MIT License](LICENSE) under which the code is
distributed.
...
- **Code** (loaders, scripts, schema, TypeScript types): [MIT](LICENSE).
- **Data** (the compiled facts): redistributed for reference under the MIT terms;
  attribution to GeoAlgeria is appreciated. You remain responsible for complying with
  the terms of the original/underlying sources for your particular use.
