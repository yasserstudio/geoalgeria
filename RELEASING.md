...
GeoAlgeria publishes eleven packages to npm — **`geoalgeria`** (the dataset, kept
...
**`@geoalgeria/enseignement-superieur`** and **`@geoalgeria/tourisme`** (under the
...
3. **Trusted Publisher per package** — on npmjs.com, for each of `geoalgeria`,
   ...
   `@geoalgeria/enseignement-superieur`, `@geoalgeria/tourisme`: *Settings →
