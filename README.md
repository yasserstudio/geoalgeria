...
| **Schools** | 11,833 | Primaires, CEM, lycées & préschools classified by cycle from OpenStreetMap — bilingual, all 69 wilayas — [`@geoalgeria/ecoles`](packages/ecoles) |
...
| [`packages/ecoles`](packages/ecoles) | [`@geoalgeria/ecoles`](https://www.npmjs.com/package/@geoalgeria/ecoles) | Schools — 11,833 schools & kindergartens from OpenStreetMap, classified by cycle (primaire/moyen/secondaire/préscolaire), bilingual, all 69 wilayas, with commune/wilaya linkage |
