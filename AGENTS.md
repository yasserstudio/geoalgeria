...
| `packages/cliniques/` | `@geoalgeria/cliniques` | clinics & proximity-care facilities – 2,059 polycliniques, salles de soins, centres de santé, maternités & private clinics from OpenStreetMap, classified by type, bilingual, 66 wilayas; the community tier of the health sector, disjoint from `sante` (registry tier) |
