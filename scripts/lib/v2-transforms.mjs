...
export const MIGRATIONS = {
  ...
  banques: {
    ...
    meta: {
      ...
      estimatedUniverse: null,
      coverageNote: "The Banque d'Algérie agréé roster (21 banks + 8 financial institutions) is complete. Branch locations cover all 21 banks' own locators (1,704 branches); 1,494 carry a geocoded point, including all 191 BDL branches from the bank's published Google My Maps and eight additional BDL and SGA positions reviewed against OpenStreetMap by bank, wilaya, locality, and agency number or street address. The rest remain address-only (see README).",
