  ...
  buses: {
    ...
    meta: {
      sources: [
        ...
        { key: "etus-setif", name: "ETUS Setif — official 2026 Line announcement", url: "https://www.govserv.org/DZ/S%C3%A9tif/111330534776381/ETUS-S%C3%89TIF", license: "Proprietary factual reference data; no open reuse license", retrieved: "2026-09-02", evidence_type: "official" },
      ...
      estimatedUniverse: null,
      coverageNote: "Reviewed urban/suburban release: 50 retained ETUSA Lines, 8 official ETUS Sidi Bel Abbès Lines, 7 current ETUS Tiaret Lines, 5 official ETUS Béjaïa Lines, 5 official ETUSTO Lines, 5 official ETUS Setif Lines, 4 official ETUS M'Sila Lines and 1 ETUS Mostaganem Line. Setif Line identities and Arabic endpoints come from official 2026 Operator artwork; Line 101 has reusable OSM geometry matched to the announced terminal at حي الأبراج (Les Tours). Béjaïa Line identity, endpoints, typed stop counts and service hours come from the Operator API and linked timetable panels; Sidi Bel Abbès identities, endpoints and complete directional departures come from supplied official network/timetable HTML; M'Sila identities, endpoints and stop counts come from official route diagrams. Operator-controlled map geometry remains validation-only. OSM supplies reusable geometry where available. Shapes are available for 33 ETUSA, 7 Tiaret, 3 Tizi Ouzou, 1 Setif and 1 Mostaganem Lines. Excludes stale Tiaret ref 33 plus unresolved, taxi, cross/inter-wilaya, unmatched Setif, ETUAD and validation-only geometry.",
