...
| **Rail & transport urbain** | 744 | nœuds train, tram, métro, téléphérique & télécabine (SNTF / SETRAM / SEMA) — composite Wikidata + OSM, bilingue, 50 wilayas — [`@geoalgeria/ferroviaire`](packages/ferroviaire) |
...
| [`packages/ferroviaire`](packages/ferroviaire) | [`@geoalgeria/ferroviaire`](https://www.npmjs.com/package/@geoalgeria/ferroviaire) | Rail & transport urbain — 744 nœuds train/tram/métro/téléphérique/télécabine (SNTF/SETRAM/SEMA), composite Wikidata + OSM, bilingue FR/AR |
