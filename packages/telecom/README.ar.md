...
تغطي **65 ولاية حالية**. لا تزال خرائط المشغلين تستخدم تقسيم 58 ولاية؛ وقد
أعيد ربط 25 نقطة لموبيليس بسبع ولايات جديدة بعد تحقق صارم.
...
إعادة الجلب. `wilaya_code` يرتبط برمز الولاية الحالي في GeoAlgeria. في 25
...
عند تطابق اسم بلدية فريد مع احتواء المضلع. الكتابة تتم بالكامل أو لا تتم على
