...
| Liaisons sans escale | **124** | liaisons directionnelles avec exploitant, statut, niveau de preuve et source |
| Liaisons planifiées | **18** | annoncées, pas encore exploitées ; une collection distincte, jamais un statut |
