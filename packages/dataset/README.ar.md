...
| [`@geoalgeria/cliniques`](https://www.npmjs.com/package/@geoalgeria/cliniques) | العيادات ومرافق الرعاية الجوارية – 1,880 عيادة متعددة الخدمات وقاعة علاج ومركز صحي ومصحة توليد وعيادة خاصة من OpenStreetMap، مُصنَّفة حسب النوع، ثنائية اللغة، 66 ولاية |
