...
**دقة الإحداثيات** (`geo_precision`): `commune_centroid` (126) · `wilaya_centroid` (45).
...
> أسماء المتعاملين وطبيعة PP/DM **رسمية** (سجل الوزارة). لا يتضمّن السجل أي إحداثيات: يوضَع كل سجلّ عند مركز بلديته المُحدَّدة، أو — عند معرفة الولاية فقط — عند مركز الولاية (انظر `geo_precision`). هذه مواقع تقريبية للولاية/البلدية، وليست نقاطًا مساحية للمصنع.
>
