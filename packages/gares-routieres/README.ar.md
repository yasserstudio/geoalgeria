...
يتضمن المعرّف رمز الولاية، لذلك قد يؤدي تصحيح إحداثيات محطة إلى نقلها إلى ولاية
أخرى ومنحها معرّفًا جديدًا. أما المعرّف الذي تتركه فيُسجَّل في
`data/retired-ids.json` ولا يُعاد استعماله أبدًا، حتى لا ترث محطة لاحقة مفتاح ربط
كان يشير إلى شيء آخر. سبعة معرّفات حتى الآن، جميعها بسبب خط طول في المصدر وضع
المحطة في الولاية الخاطئة:
