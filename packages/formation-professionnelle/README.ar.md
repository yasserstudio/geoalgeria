...
تغطي **58 ولاية** (المخطط قبل الإصلاح). 1,920 من أصل 1,932 مؤسسة محددة الإحداثيات
...
`"approximate"` ومُوضّح في `geo_method`. `wilaya_code` يستخدم مخطط 58 ولاية كما هو منشور
من المصدر.
