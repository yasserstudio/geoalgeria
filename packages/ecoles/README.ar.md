...
**11٬833 مدرسة بإحداثيات جغرافية** عبر **69 ولاية** في الجزائر — كلٌّ بإحداثياته،
...
const all = ecoles.ecoles();   // 11٬833 مدرسة بإحداثيات
...
- **خرائط وأدلّة المدارس** — إحداثيات على كامل السجلّات الـ11٬833، جاهزة لخريطة أو
...
| --- | --- | --- | --- |
| المدارس | **11٬833** | ✅ الكل | 8٬643 مُسمّاة، 69 ولاية |

**حسب الطور**

| الطور | العدد | المعنى |
| --- | --- | --- |
| `primaire` | 3٬969 | مدرسة ابتدائية (ISCED 1) |
| `moyen` | 2٬378 | متوسطة / CEM (ISCED 2) |
| `secondaire` | 1٬575 | ثانوية / lycée (ISCED 3) |
| `prescolaire` | 283 | تحضيري / روضة (ISCED 0) |
| `autre` | 3٬628 | مدرسة غير محدّدة الطور (بلا اسم، أو اسمٌ بلا كلمة طور) |
...
تبقّى دون حسمٍ فهو `autre`. تحصل 92٪ من المدارس *المُسمّاة* على طورٍ محدّد.
...
```
data/
  ecoles.json              # 11٬833 مدرسة (مصفوفة)
