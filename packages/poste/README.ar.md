...
دوريًا. لا يزال BaridiMap يصنف المكاتب وفق نظام 58 ولاية؛ لذلك تربطها
GeoAlgeria بالولاية الحالية عبر `commune_code` المرجعي، وتحفظ قيمة المصدر في
`source_wilaya_code` عند اختلافها. يبقى ربط أجهزة الصراف كما نشره المصدر لأن
BaridiMap لا يوفر لها رمز بلدية ثابتًا.
