...
> `commune_code` لـ86 جهازًا فقط عند تطابق اسم البلدية والولاية الأم وموقع النقطة.
...
قيمة المصدر غير الموثقة `"1"`)؛ يُملأ `commune_code` في 86 سجلًا مؤكّدًا ويبقى
...
المكاتب عبر `commune_code` المرجعي، ويربط 86 جهاز صراف عندما يتطابق اسم البلدية
