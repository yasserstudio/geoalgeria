...
> `commune_code` لـ79 جهازًا فقط عند تطابق اسم البلدية والولاية الأم وموقع النقطة.
...
قيمة المصدر غير الموثقة `"1"`)؛ يُملأ `commune_code` في 79 سجلًا مؤكّدًا ويبقى
...
المكاتب عبر `commune_code` المرجعي، ويربط 79 جهاز صراف عندما يتطابق اسم البلدية
الفرنسي الفريد وعلاقة الولاية الأم والمضلع الوحيد الذي يحتوي النقطة. يحتفظ
