...
| **العيادات ومرافق الرعاية** | 1,880 | عيادات متعددة الخدمات وقاعات علاج ومراكز صحية ومصحات توليد وعيادات خاصة من OpenStreetMap، مُصنَّفة حسب النوع، ثنائية اللغة، 66 ولاية. الطبقة المجتمعية إلى جانب سجلّ `sante`، ولا تُجمع معه أبدًا. [`@geoalgeria/cliniques`](packages/cliniques) |
...
| [`packages/cliniques`](packages/cliniques) | [`@geoalgeria/cliniques`](https://www.npmjs.com/package/@geoalgeria/cliniques) | العيادات ومرافق الرعاية الجوارية، 1,880 مرفقًا بإحداثيات من OpenStreetMap عبر 66 ولاية، مُصنَّفة حسب النوع (عيادة متعددة الخدمات/قاعة علاج/مركز صحي/مصحة توليد/عيادة)، ثنائية اللغة، مع القطاع والتخصّص والهاتف والأوقات عند توفّرها؛ الطبقة المجتمعية لقطاع الصحة، ويُستبعَد منها كل عنصر OSM يُشير إليه `sante` |
