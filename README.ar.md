...
| **السكك والنقل الحضري** | 744 | عُقَد القطار والترامواي والمترو والتلفريك (SNTF / SETRAM / SEMA) — تجميعة Wikidata + OSM، ثنائية اللغة، 50 ولاية — [`@geoalgeria/ferroviaire`](packages/ferroviaire) |
...
| [`packages/ferroviaire`](packages/ferroviaire) | [`@geoalgeria/ferroviaire`](https://www.npmjs.com/package/@geoalgeria/ferroviaire) | السكك والنقل الحضري — 744 عقدة قطار/ترامواي/مترو/تلفريك (SNTF/SETRAM/SEMA)، تجميعة Wikidata + OSM، ثنائية اللغة |
